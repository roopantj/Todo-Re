...
var login_default = "/build/_assets/login-KNH7QQGH.css";
...
function Login() {
  ...
  const [loginType, updateLoginType] = (0, import_react.useState)(((_a = actionData == null ? void 0 : actionData.fields) == null ? void 0 : _a.loginType) ? (_b = actionData == null ? void 0 : actionData.fields) == null ? void 0 : _b.loginType : "register");
  const [searchParams] = (0, import_remix6.useSearchParams)();
  const toggleLoginType = () => {
    if (loginType === "register")
      updateLoginType("login");
    else
      updateLoginType("register");
  };
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("script", {
    ...
    placeholder: "Name",
    type: "text",
    defaultValue: (_c = actionData == null ? void 0 : actionData.fields) == null ? void 0 : _c.name,
    id: "username-input",
    name: "username"
  })), /* @__PURE__ */ React.createElement("div", {
    className: "input-field"
    ...
    type: "submit"
  }, "Submit"))), /* @__PURE__ */ React.createElement("p", null, loginType === "register" ? "Already have an account ? " : "Create an account ", /* @__PURE__ */ React.createElement("button", {
    style: { color: "#3a0d55" },
