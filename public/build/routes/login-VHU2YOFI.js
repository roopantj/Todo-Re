...
function Login() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("script", {
    ...
    type: "hidden",
    name: "redirectTo",
    value: (_c = searchParams.get("redirectTo")) != null ? _c : void 0
  }), /* @__PURE__ */ React.createElement("input", {
    type: "hidden",
    name: "loginType",
    value: loginType
    ...
    placeholder: "Name",
    type: "text",
    defaultValue: (_d = actionData == null ? void 0 : actionData.fields) == null ? void 0 : _d.name,
    id: "username-input",
    name: "username"
  })), /* @__PURE__ */ React.createElement("div", {
    className: "input-field"
...
//# sourceMappingURL=/build/routes/login-VHU2YOFI.js.map
